...
export class GeneralResolver {
  ...
  // products reviews
  @Public()
  @Mutation(() => ProductReviews, {
    name: "Create_prod_Reviews",
    nullable: true,
  })
  ...
  // jobs Applications
  @Public()
  @Mutation(() => JobsApplication, {
    name: "Create_jobs_applications",
    nullable: true,
  })
  ...
  @Public()
  @Query(() => [JobsApplication], {
    name: "get_All_jobs_applications",
    nullable: true,
  })
  ...
  @Mutation(() => JobsApplication, {
    name: "update_jobs_applications",
    nullable: true,
  })
  updatejobApplication(
    @Args("UpdateCreateJobApplicationDto")
    UpdateCreateJobApplicationDto: UpdateCreateJobApplicationDto,
  ) {
    return this.generalService.updatejobApplication(UpdateCreateJobApplicationDto);
  }

  @Mutation(() => JobsApplication, {
    name: "Delete_jobs_applications",
    nullable: true,
  })
