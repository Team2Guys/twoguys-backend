...
export class EComereceResolver {
  ...
  PaginatedPrducts(@Args("PaginatedPrducts") PaginatedPrducts: PaginatedPrducts) {
    return this.eComereceService.CategorygetPaginatedProducts(
      PaginatedPrducts.categoryname,
      PaginatedPrducts.page,
      PaginatedPrducts.pageSize,
      PaginatedPrducts.subcategory,
    );
  }
}
